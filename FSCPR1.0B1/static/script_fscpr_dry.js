...
const add_btn = document.querySelector(".add_btn--dry");
...
add_btn.addEventListener("click", function() {
    ...
    // Create row, td, and td contents
        ...
        new_shelf.setAttribute("class", "shelf_ud_dry");
        ...
        new_production.setAttribute("class", "production_ud_dry");
        ...
        new_date.setAttribute("class", "exp_ud_dry");
        ...
        new_portions.setAttribute("class", "ptns_ud_dry")
        ...
        new_batches.setAttribute("class", "batches_ud_dry")
        ...
        new_batch_size.setAttribute("class", "batch_size_ud_dry")
    ...
    // The siblings for select must be created after it in the stack and are below, as they need the added select's Id 
        ...
        new_select.setAttribute("class", "prep_ud_dry")
        ...
        new_remove.setAttribute("class", "discard_ud_dry");
