...
const add_btn = document.querySelector(".add_btn--cooler");
...
add_btn.addEventListener("click", function() {
    ...
    // Create row, td, and td contents
        ...
        new_shelf.setAttribute("class", "shelf_ud");
        ...
        new_production.setAttribute("class", "production_ud");
        ...
        new_date.setAttribute("class", "exp_ud");
        ...
        new_portions.setAttribute("class", "ptns_ud")
        ...
        new_batches.setAttribute("class", "batches_ud")
        ...
        new_batch_size.setAttribute("class", "batch_size_ud")
    ...
    // The siblings for select must be created after it in the stack and are below, as they need the added select's Id 
        ...
        new_select.setAttribute("class", "prep_ud")
        ...
        new_remove.setAttribute("class", "discard_ud");
